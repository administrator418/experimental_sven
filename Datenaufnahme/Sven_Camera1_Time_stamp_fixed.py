...
if nRet != ueye.IS_SUCCESS:
    raise ValueError("is_InitCamera ERROR Camera 1")
...
for i in range(z):
    ...
    for j in range(1):  # Für jedes z nur ein Bild 
        ...
        file_name = f"{i+1}_idx_{str_current_datetime}_c1_1.png"
        ...
        for i in range(num):
            ...
            #path_camera_1 = r'C:\Sven\Schramberg_Datacollection\camera_1'
            #path_camera_1 = r'C:\Sven\Schramberg_Datacollection\reference_camera_1'
            path_camera_1 = r'C:\Sven\Schramberg_Datacollection\Correction_NF_FF\camera_1'
...
if hCam:
    ...
    if nRet != ueye.IS_SUCCESS:
        print("is_ExitCamera ERROR Camera 1")
