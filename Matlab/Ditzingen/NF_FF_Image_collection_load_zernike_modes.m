...
%T=readtable('\\srvditz1\lac\Studenten\AE_VoE_Stud\Sven Burckhard\Predict_Phasemask\Evaluation_Vortex\Unwrapped_Vortex\combined_coeff.csv');
T=readtable('\\srvditz1\lac\Studenten\AE_VoE_Stud\Sven Burckhard\Predict_Phasemask\Evaluation_Vortex\Test_Random_200_phasemasks\combined_coeff.csv');
p=T{:,:};
%q=T{:,:};
save('coeff.mat','p')
...
coeff=coeff.p;
%Select coeff
%coeff = coeff(11950:12000,:);
coeff = coeff(1:200,:);
%coeff = coeff(11951:20950,:);
...
%     'DataAspectRatio',[1 1 1]);
    ...
    d = 'C:\Local_Scripts\Gaussian_Evaluation_2\phasemask\';
    % d= 'E:\phasemask\';
    P = angle(WF_function);
...
%writematrix(coeff, '\\srvditz1\lac\Studenten\AE_VoE_Stud\Sven Burckhard');
